...
__doc__ = "Converts sympy expressions into autogenerated code then compiles the code and finally" \
          " packages it into a module." \
          "Developed from sympy.autowrap module. " \
          "Tool to abstract the code printing so mathematical expressions" \
          "can easily be creating in sympy and converted to compiled code for efficient execution." \
          "Creates a python module containing the required functions. " \
          "Module created in current working directory."
